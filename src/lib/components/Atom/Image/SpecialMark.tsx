    ...
    >
      <div
        style={{
          whiteSpace: "nowrap",
          fontWeight: 900,
          textShadow: `${height / 40}px ${height / 40}px ${
            height / 40
          }px white, -${height / 40}px -${height / 40}px ${
            height / 40
          }px white, -${height / 40}px ${height / 40}px ${
            height / 40
          }px white, ${height / 40}px -${height / 40}px ${
            height / 40
          }px white, ${height / 40}px 0px ${height / 40}px white, -${
            height / 40
          }px -0px ${height / 40}px white, 0px ${height / 40}px ${
            height / 40
          }px white, 0px -${height / 40}px ${height / 40}px white`,
      ...
      <img
        ...
        onClick={() => {
          if (
            ...
            centerFocusFunction(
              leftDistance + imgRef.current.clientWidth,
              topDistance + imgRef.current.clientHeight,
            );
          } else {
