...
const CurrentLocationMark = ({screenHookHeight}: { screenHookHeight: number }) => {
    ...
    useEffect(() => {
        if (location == null || location.latitude==null || location.longitude==null) {
            ...
            const leftPosition: number = (-0.000589793087) * ((lng - 135.9) * 10000000.0) + (-0.0147832620) * ((lat - 34.9) * 10000000.0) + 13338.8909;
            const topPosition: number = (-0.0121005479) * ((lng - 135.9) * 10000000.0) + 0.000820999080 * ((lat - 34.9) * 10000000.0) + 7443.09013;
