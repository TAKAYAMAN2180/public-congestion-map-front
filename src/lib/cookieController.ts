...
import {DeductionInfoType, DeductionsSummaryType} from "@/src/lib/type/DeductionDataType";
import {Congestion as APICongestionType} from "@/src/graphql/API";
import StoresInfoType from "@/src/lib/type/StoresInfoType";

export const COOKIE_NAMES = ["bkc_fes_databaseValue", "bkc_fes_storeIndex"] as const;
